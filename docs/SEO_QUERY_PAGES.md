...
| ekonomiskt stöd och ersättningar privatperson | `/privatperson/ersattningar/` | applicant=individual ∧ instrument=social_benefit | 31 | **INDEX** | 31 matchande stöd; materiellt mer specifik än målgruppshubben; varje stöd har officiell källa |
