...
| 17 | Skeptical taxpayer test | Planerad (generation mode) | Additionalitet/offentlig nytta finns som mallfrågor (varför räcker inte egna resurser — medfinansieringsbalansen vaktar redan) |
...
| 22 | Human voice — naturlig, konkret; aldrig medvetna fel för att simulera mänsklighet | Planerad (generation mode) | Absolut regel redan nu: systemet producerar bara sökandens egna ord |
| 23 | Application polish — polering får aldrig ändra sakförhållanden | Planerad (generation mode) | |
