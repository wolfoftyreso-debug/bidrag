...
- M15 Överlastad faktaväg `person.ageUnder29` (funnen 2026-08-30 när situationslagret härledde frågor ur seeden) — två stöd delar faktavägen men prövar olika åldersspann: `fk-bbu-m1` "Du ska vara mellan 18 och 28 år" och `fk-ae-m1` "Du ska vara 19–29 år". Ett ja på den ena frågan sätter faktumet för båda, så en 29-åring markeras som passerande för bostadsbidrag unga. Rätt åtgärd är samma som M11:s: per-gräns-fakta härledda ur födelseåret (`person.age18to28`, `person.age19to29`) i stället för en delad boolean. Kräver seedändring + i18n-poster i alla tio filerna.
