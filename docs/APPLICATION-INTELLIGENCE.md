...
| §6 Requirement Matrix | **Implementerad (växande täckning)** | Schemamotor med kanoniska nycklar och villkorsfält; 70/84 stöd har kurerat schema (Formas öppna utlysning är den avsiktliga K3-vaktposten) — stöd utan schema flaggas öppet i granskningen (K3 fail-safe) |
