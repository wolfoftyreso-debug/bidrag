...
const SCRIPTS = {
  ...
  'verify:a11y': 'Riktad tillgänglighetsgenomgång med axe-core (WCAG 2.x A/AA) genom inloggning, intag, analys, köp, arbetsyta och konto — fäller på serious/critical. Kräver körande api + web.',
